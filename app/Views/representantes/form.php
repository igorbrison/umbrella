 ...
 * 
 * Este formulário é usado tanto para CADASTRAR novos representantes
 * quanto para EDITAR existentes.
 * 
 * Comportamento:
 ...
 * 
 * Observação: O campo "Ativo" foi removido deste formulário. O administrador
 * pode ativar/desativar o representante diretamente na listagem.
 */
...
<form method="POST" action="/admin/representantes/salvar" id="form-representante">
    ...
    <!-- ===================== OBSERVAÇÕES (SEM CHECKBOX ATIVO) ===================== -->
    ...
    btnBuscarCnpj.addEventListener('click', function() {
        ...
        fetch('/api/buscar_cnpj.php?cnpj=' + cnpj)
            ...
            .then(data => {
                ...
                console.log('Inscrição Estadual e CRT devem ser preenchidos manualmente.');
            })
            .catch(error => {
                loadingCnpj.style.display = 'none';
