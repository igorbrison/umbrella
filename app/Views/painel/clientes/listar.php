...
<!-- Tabela (com data-label para mobile) -->
    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td data-label="CPF/CNPJ"><?= htmlspecialchars($c['cpf_cnpj']) ?></td>
                <td data-label="Email"><?= htmlspecialchars($c['email']) ?></td>
                <td data-label="Valor Total">R$ <?= number_format($c['valor_total_atual'] ?? 0, 2, ',', '.') ?></td>
